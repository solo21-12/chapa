    ...
    >
      <div className={` flex-col xl:px-0 lg:px-16 ${styles.flexStart} `}>
        ...
        <div className=" flex flex-row justify-between items-center w-full">
          <h1 className=" flex-1 font-poppins font-semibold xl:text-[72px] ss:text-[53px] text-[40px] text-White xl:leading-[100px] ss:leading-[60px] leading-[43px]">
        ...
        <h1 className=" font-poppins font-semibold ss:text-[53px] xl:text-[70px] text-[34px] text-White xl:leading-[100px] ss:leading-[60px] leading-[43px] w-full">
          Payment Method.
        </h1>
        <p
          className={`${styles.paragraph} max-w-[470px] mt-5  text-LightSlate font-[400] text-[11px] ss:text-[15px] lg:text-[18px]`}
        >
      ...
      <div className=" mt-10 w-full md:w-[40%] flex-shrink-0 ">
        <Image
          src="/hero2.png"
          alt="hero"
          width={500}
